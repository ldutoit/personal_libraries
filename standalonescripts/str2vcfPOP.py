...
##Writen by Ludovic Dutoit, July 2018, dutoit.ludovic@gmail.com for any questions
...
for i,loc in enumerate(loci):
	...
	newline = "chr%s\t%s\t.\t%s\t%s\t.\tPASS\tNS=75;AF=0.007\tGT:DP:AD:GQ:GL" %(chrom,pos,alleles.split("/")[0],alleles.split("/")[1])
	genotypes =[dict_individuals[ind][0][i]+"/"+dict_individuals[ind][1][i]+tr_random[dict_individuals[ind][0][i]+"/"+dict_individuals[ind][1][i]] for ind in dict_individuals.keys()]
